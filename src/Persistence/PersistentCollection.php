...
final class PersistentCollection extends AbstractLazyCollection implements Selectable
{
    ...
    {
        if ( ! $this->initialized && $this->association['fetch'] === ClassMetadataInfo::FETCH_EXTRA_LAZY) {
    ...
    {
        if ( ! $this->initialized
            && $this->association['fetch'] === ClassMetadataInfo::FETCH_EXTRA_LAZY
            && isset($this->association['indexBy'])
        ) {
    ...
    {
        if ( ! $this->initialized && ! $this->isDirty && $this->association['fetch'] === ClassMetadataInfo::FETCH_EXTRA_LAZY) {
            $persister = $this->em->getUnitOfWork()->getCollectionPersister($this->association);
    ...
    /**
     * Overridden: backRefFieldName is optional now
     *
